<?php 
//Baixa a lista de candidatos a presidente
//http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/BR/2022802018/1/candidatos
set_time_limit(0);
$estados = array( "BR" );

// $arquivo = 'lista-candidatos-vice-governador-2018.xls';
...
echo '</tr>';
	...
	$url = 'http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/' . $uf . '/2022802018/1/candidatos';
