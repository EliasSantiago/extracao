<?php 
//Baixa a lista de candidatos a governador
//Fonte: http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/DF/2022802018/3/candidatos
set_time_limit(0);
$estados = array( "AC", "AL", "AM", "AP", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG", "PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RO", "RS", "RR", "SC", "SE", "SP", "TO" );

$arquivo = 'lista-candidatos-governador-2018.xls';
...
echo '</tr>';
	...
	$url = 'http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/' . $uf . '/2022802018/3/candidatos';
